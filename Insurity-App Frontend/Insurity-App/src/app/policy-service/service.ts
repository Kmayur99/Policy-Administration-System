...
export class Service {
  ...
  viewConsumerBusiness(consumerId: any): Observable<ConsumerBusinessDetails>{
  ...
  createBusinessProperty(businessPropertyRequest: BusinessPropertyRequest){
    console.log("this is in createBusinessProperty service.ts");
  ...
  viewBusinessProperty(consumerId: any, propertyId: any): Observable<Property>{
  ...
  getQuotes(businessValue: number, propertyValue: number, propertyType: string){
    console.log("getQuotes in service.ts");
  ...
  viewPolicy(consumerId: any, policyId: any): Observable<PolicyDetailsResponse>{
